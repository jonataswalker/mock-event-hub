 ...
 */
export declare function isHubRuntimeInfo(entityPath: string, message: Message): boolean;
 ...
 */
export declare function generateHubRuntimeInfoResponse({ correlationId, partitions, targetLinkName, createdOn, eventHubName, }: GenerateHubRuntimeInfoResponseOptions): Message;
